...
int Topology::CONFIG_CACHE_MEMORY_BOUND=0;
int Topology::TraceSize = length_indices[CONFIG_CACHE_MEMORY_BOUND]-1;
//============================================================
    ...
    for(int r2=0; r2<7; ++r2)
        for(int r1=1; r1<7; ++r1)
            for(int r0=1; r0<7; ++r0)
            {
                ...
                F.push_back(SideMarks[r1]);
                S[r1-1]=true;
                C[1]=Sides[r1-1];
                F.push_back(SideMarks[r0]);
                S[r0-1]=true;
                C[0]=Sides[r0-1];
...
void Topology::initCache(const int& C)
{
  if(C!=CONFIG_CACHE_MEMORY_BOUND)
   {
     CONFIG_CACHE_MEMORY_BOUND=C; 
